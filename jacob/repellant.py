...
class Fish():
    ...
    def move(self, neighbors, rel_pos):
        ...
        if loc[0] < 30:
            utils.xb.add((loc[1] // 100, loc[2] // 100))
        elif loc[0] > 1750: # hardcode for now
            utils.xt.add((loc[1] // 100, loc[2] // 100))
        if loc[1] < 30:
            utils.yb.add((loc[0] // 100, loc[2] // 100))
        elif loc[1] > 1750:
            utils.yt.add((loc[0] // 100, loc[2] // 100))
        if loc[2] < 30:
            utils.zb.add((loc[0] // 100, loc[1] // 100))
        elif loc[2] > 1140:
            utils.zt.add((loc[0] // 100, loc[1] // 100))
